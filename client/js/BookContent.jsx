/* eslint-disable react/no-unused-state,no-unused-vars,consistent-return,class-methods-use-this,array-callback-return,prefer-destructuring,no-underscore-dangle,jsx-a11y/click-events-have-key-events,jsx-a11y/no-noninteractive-element-interactions */
...
class BookContent extends Component {
  ...
  componentDidMount() {
    const { loadBook, match } = this.props;
